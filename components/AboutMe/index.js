...
export function AboutMe() {
    return (
        <section id="about" className='min-h-[400px] flex flex-col items-center p-6 justify-center md:px-6 md:pt-24'>
            ...
            <div className='flex items-center justify-center'>
                ...
                <div className=' w-80 h-80 hidden md:block'>
            ...
            <hr className="w-4/5 h-[1px] border-0 bg-gray-400 bottom-1 mt-20" />
        </section>
    )
}